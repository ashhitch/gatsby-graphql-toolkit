...
const compile_gatsby_fragments_1 = require("../compile-gatsby-fragments");
...
it(`works without custom fragments`, () => {
    const fragmentDoc = (0, compile_gatsby_fragments_1.compileGatsbyFragments)({
        schema,
...
it(`prefixes type names in fragment type condition`, () => {
    const fragments = (0, compile_gatsby_fragments_1.compileGatsbyFragments)({
        schema,
    ...
    expect((0, test_utils_1.printFragment)(fragments, `Foo`)).toEqual((0, test_utils_1.dedent) `
...
it(`prefixes connection type names`, () => {
    ...
    expect((0, test_utils_1.printFragment)(fragments, `Bar`)).toEqual((0, test_utils_1.dedent) `
...
//# sourceMappingURL=compile-gatsby-fragments.test.js.map