...
describe(`simple types (scalars, objects)`, () => {
    it(`works with simple fields`, () => {
        const result = (0, generate_default_fragments_1.generateDefaultFragments)({
            schema,
            gatsbyNodeTypes: [nodeTypes.Foo],
        });
        expect(result.size).toEqual(1);
        expect(result.get(`Foo`)).toEqual((0, test_utils_1.dedent) `
      fragment Foo on Foo {
        testId
        string
        int
    ...
    it(`works with nested simple fields`, () => {
        ...
        expect(result.size).toEqual(1);
        expect(result.get(`Bar`)).toEqual((0, test_utils_1.dedent) `
      fragment Bar on Bar {
        testId
        foo {
          ... on Foo {
    ...
    it(`works with self-circular node fields`, () => {
        ...
        expect(result.size).toEqual(1);
        expect(result.get(`SelfCycle`)).toEqual((0, test_utils_1.dedent) `
    ...
    it(`works with circular node fields`, () => {
        ...
        expect(result.size).toEqual(2);
        expect(result.get(`WithCycle`)).toEqual((0, test_utils_1.dedent) `
    ...
    it(`works with transitive cyclic non-node fields`, () => {
        ...
        expect(result.size).toEqual(1);
        expect(result.get(`WithTransitiveCycle`)).toEqual((0, test_utils_1.dedent) `
    ...
    it(`aliases internal Gatsby fields on node types`, () => {
        ...
        expect(result.size).toEqual(1);
        expect(result.get(`WithGatsbyFields`)).toEqual((0, test_utils_1.dedent) `
    ...
    it(`includes fields with nullable arguments only (by default)`, () => {
        ...
        expect(result.get(`WithArguments`)).toEqual((0, test_utils_1.dedent) `
...
describe(`abstract types (interfaces, unions)`, () => {
    it(`works with fields of non-node interface type`, () => {
        ...
        expect(result.size).toEqual(1);
        expect(result.get(`WithIfaceFoo`)).toEqual((0, test_utils_1.dedent) `
    ...
    it(`works with fields of non-node union type`, () => {
        ...
        expect(result.size).toEqual(1);
        expect(result.get(`WithFooUnion`)).toEqual((0, test_utils_1.dedent) `
    ...
    it(`works with circular node interface fields`, () => {
        ...
        expect(result.size).toEqual(3);
        expect(result.get(`WithIfaceSelfCycle`)).toEqual((0, test_utils_1.dedent) `
    ...
    `);
        expect(result.get(`IfaceSelfCycleImpl1`)).toEqual((0, test_utils_1.dedent) `
    ...
    `);
        expect(result.get(`IfaceSelfCycleImpl2`)).toEqual((0, test_utils_1.dedent) `
    ...
    it.skip(`ignores conflicting fields of non-node interfaces and unions`, () => {
        ...
        expect(result.size).toEqual(1);
        expect(result.get(`WithFooConflict`)).toEqual((0, test_utils_1.dedent) `
...
//# sourceMappingURL=generate-default-fragments.test.js.map