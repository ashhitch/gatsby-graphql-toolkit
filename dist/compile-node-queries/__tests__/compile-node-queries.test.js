...
describe(`Happy path`, () => {
  ...
  `);
    ...
    it(`adds __typename in the top-level node field`, () => {
        const queries = (0, compile_node_queries_1.compileNodeQueries)({
            schema,
            gatsbyNodeTypes: [nodeTypes.Foo],
            customFragments: [],
        });
        expect(queries.size).toEqual(1);
        expect((0, test_utils_1.printQuery)(queries, `Foo`)).toEqual((0, test_utils_1.dedent) `
      query LIST_Foo {
        allFoo {
    ...
    it(`adds __typename in the top-level node field within connection`, () => {
        ...
        expect(queries.size).toEqual(1);
        expect((0, test_utils_1.printQuery)(queries, `Baz`)).toEqual((0, test_utils_1.dedent) `
      query LIST_Baz {
        allBaz {
          edges {
            node {
    ...
    it(`works without custom fragments`, () => {
      ...
      fragment FooId on Foo { testId }
    `);
        expect((0, test_utils_1.printQuery)(queries, `Bar`)).toEqual((0, test_utils_1.dedent) `
      query LIST_Bar {
        allBar {
          remoteTypeName: __typename
          ...BarId
    ...
    describe(`Node referencing`, () => {
      ...
      `);
        ...
        `,
            ...
            expect(queries.size).toEqual(2);
            expect((0, test_utils_1.printQuery)(queries, `WithComplexId1`)).toEqual((0, test_utils_1.dedent) `
      ...
      `);
            expect((0, test_utils_1.printQuery)(queries, `WithComplexId2`)).toEqual((0, test_utils_1.dedent) `
    ...
    describe(`Field aliasing`, () => {
      ...
      `;
            ...
            expect(queries.size).toEqual(2);
            expect((0, test_utils_1.printQuery)(queries, `WithGatsbyFields`)).toEqual((0, test_utils_1.dedent) `
      ...
      `);
            expect((0, test_utils_1.printQuery)(queries, `GatsbyFields`)).toEqual((0, test_utils_1.dedent) `
...
//# sourceMappingURL=compile-node-queries.test.js.map